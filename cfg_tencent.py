...
model_weights_path = '/scratch/xzou/icpr2/model/weights_%s.{epoch:03d}-{val_loss:.3f}.h5' \
                     % train_task_id
saved_model_file_path = '/scratch/xzou/icpr2/saved_model/east_model_%s.h5' % train_task_id
saved_model_weights_file_path = '/scratch/xzou/icpr2/saved_model/east_model_weights_%s.h5'\
                                % train_task_id
